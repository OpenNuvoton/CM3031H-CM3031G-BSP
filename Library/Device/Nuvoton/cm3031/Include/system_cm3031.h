/**************************************************************************//**
 * @file     system_cm3031.h
 * @version  V3.00
 * @brief    CMSIS Cortex-M33 Core Peripheral Access Layer Header File for CM3031
 *
 * @copyright SPDX-License-Identifier: Apache-2.0
 * @copyright Copyright (c) 2024-2025 Nuvoton Technology Corp. All rights reserved.
*****************************************************************************/

#ifndef __SYSTEM_CM3031_H__
#define __SYSTEM_CM3031_H__
