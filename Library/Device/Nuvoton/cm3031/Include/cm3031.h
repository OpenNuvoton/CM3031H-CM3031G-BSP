 ...
 * @file     cm3031.h
 * @version  V3.00
 * @brief    CM3031 peripheral access layer header file.
 *           This file contains all the peripheral register's definitions,
 *           bits definitions and memory mapping for NuMicro CM3031 MCU.
 *
 * @copyright SPDX-License-Identifier: Apache-2.0
 * @copyright (c) 2025 Nuvoton Technology Corp. All rights reserved.
 *****************************************************************************/
/**
  \mainpage NuMicro CM3031 Driver Reference Guide
  *
  * <b>Introduction</b>
  *
  * This user manual describes the usage of CM3031 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
typedef enum IRQn
{
    ...
    /******  CM3031 Specific Interrupt Numbers *******************************************************/
...
#include "system_cm3031.h"            /* System include file                         */
