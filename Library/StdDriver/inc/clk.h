...
/* For CM3033Gx/CM3034Gx */
#define CLK_SPDSRETSEL_32K_CM3031G   (0x1UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 32K SRAM retention when chip enter SPD mode for CM3031G \hideinitializer */
#define CLK_SPDSRETSEL_64K_CM3031G   (0x2UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 64K SRAM retention when chip enter SPD mode for CM3031G \hideinitializer */
#define CLK_SPDSRETSEL_96K_CM3031G   (0x3UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 96K SRAM retention when chip enter SPD mode for CM3031G \hideinitializer */

/* For CM3033Hx/CM3034Hx */
#define CLK_SPDSRETSEL_64K_CM3031H   (0x1UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 64K SRAM retention when chip enter SPD mode for CM3031H \hideinitializer */
#define CLK_SPDSRETSEL_192K_CM3031H  (0x2UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 192K SRAM retention when chip enter SPD mode for CM3031H \hideinitializer */
#define CLK_SPDSRETSEL_320K_CM3031H  (0x3UL << CLK_PMUCTL_SRETSEL_Pos)     /*!< 320K SRAM retention when chip enter SPD mode for CM3031H \hideinitializer */
