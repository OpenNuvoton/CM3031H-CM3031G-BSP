...
#ifndef PARTITION_CM3031
#define PARTITION_CM3031
...
#define SAU_INIT_REGION(n) \
    ...
    /*
    Default CM3031 pritition configuration file is for non-TrustZone sample code only.
    If user wants to use TrurstZone, they should have their partition_cm3031.h.
    For TrustZone projects, path of local partition_cm3031.h should be in the
    front of the include path list to make sure local partition_cm3031.h is used.

    It also apply to non-secure project of the TrustZone projects.

    */
    #error "Link to default partition_cm3031.h in secure mode. Please check your include path."
#endif
