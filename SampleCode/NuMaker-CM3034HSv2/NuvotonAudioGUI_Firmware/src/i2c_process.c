 ...
 * @file     i2c_process.c
 * @version  V1.00
 * @brief    CM3031/NAU88C22 I2C process source file
 *
...
/**
 * @brief       CM3031 I2C Callback Function
 * 
 * @param[in]   None
 * 
 * @return      None
 * 
 * @details     This function is used as CM3031 I2C callback funtion
 */
void CM3031_I2CCallback(void)
{
    uint32_t u32Status;
